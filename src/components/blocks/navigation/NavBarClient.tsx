...
export default function NavbarClient({ data }: { data: NavData }) {
        ...
        >
            <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
                ...
                <div className="hidden md:flex items-center gap-10 h-full">
                    ...
                    >
                        <button className={`flex items-center gap-1.5 text-[11px] uppercase tracking-[0.2em] font-medium transition-colors ${isShopOpen ? 'text-black' : 'text-neutral-600 hover:text-black'}`}>
                            Shop 
                            <ChevronDown 
                                size={12} 
                                strokeWidth={2} 
    ...
    <div className="absolute left-[-200px] top-[100%] w-[850px] bg-white border border-neutral-200 shadow-2xl p-0 overflow-hidden flex animate-in fade-in slide-in-from-top-1">
        ...
        <div className="grid grid-cols-3 gap-10 p-10 flex-grow">
            ...
            <div className="flex flex-col gap-8">
                ...
                <Link 
                    ...
                    onClick={() => setIsShopOpen(false)}
                >
                    <span className="border-b border-black pb-0.5 group-hover:opacity-60 transition-opacity">Shop All</span>
                    <span>→</span>
                </Link>
            </div>
        </div>
        ...
        <div className="w-[280px] relative group overflow-hidden border-l border-neutral-100 bg-neutral-50">
            <Link href="/shop/male/all" onClick={() => setIsShopOpen(false)}>
                <img 
                ...
                <div className="absolute bottom-6 left-6 text-white">
                    <p className="text-[9px] uppercase tracking-[0.3em] font-medium mb-1">New Arrivals</p>
                    <p className="text-sm font-light italic tracking-tight">Spring Summer 2026</p>
                </div>
            </Link>
        </div>
    </div>
